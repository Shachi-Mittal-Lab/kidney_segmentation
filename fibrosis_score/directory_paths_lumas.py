...
# file inputs
input_path = Path("/home/riware/images") #Eric edit
...
cortmed_weights_path = Path(
    "/home/riware/kidney_segmentation/model5_epoch8.pt" #Eric edit
)
cortmed_starting_model_path = Path(
    "/home/riware/kidney_segmentation/starting_model.pt" #Eric edit
)

# kmeans clustering centers
gray_cluster_centers = Path(
    "/home/riware/kidney_segmentation/fibrosis_score/average_centers_5.txt" #Eric edit
)
