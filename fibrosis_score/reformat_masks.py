...
def binarize_tif_images(input_folder, output_folder=None):
    ...
    for filename in os.listdir(input_folder):
        if "mask" in filename.lower(): 
            ...
            pass
# Example usage
input_folder = '/home/riware/Desktop/loose_files/tubule_annotations/dt_pt_formatted/tri'  # Replace with your actual path
output_folder = '/home/riware/Desktop/loose_files/tubule_annotations/dt_pt_formatted/tri/masks'  # Optional; can be same as input
