...
with torch.no_grad():
    ...
    #Eric edit: pred_mask call for mask/remove_artifacts before it was created 
    os.makedirs(f'{zarr_path}/mask/remove_artifacts', exist_ok=True)

    pred_mask = open_ds(zarr_path / "mask" / "remove_artifacts") #Eric edit
