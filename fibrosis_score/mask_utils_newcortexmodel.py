...
def prepare_foreground_masks(zarr_path, ref_array):
    ...
    """
    filled_cortex_mask = prepare_mask(zarr_path, ref_array, "cortex_filled")
    eroded_cortex_mask = prepare_mask(zarr_path, ref_array, "cortex_eroded")
    abnormaltissue_mask = prepare_mask(zarr_path, ref_array, "abnormaltissue")

    return filled_cortex_mask, eroded_cortex_mask, abnormaltissue_mask
